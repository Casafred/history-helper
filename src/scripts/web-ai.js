...
var AI = (function () {
  ...
  var DEFAULT_PROMPTS = {
    ...
    citedRefsAnalysis: '请对以上引用文献相关文档进行**详细分析**，包括：\n\n## 任务执行流程\n\n### 步骤1：逐篇梳理引用文献\n按文档序号顺序，对每个引用文献独立梳理：\n- 引用文献编号（完整专利号格式）、类型、引用方\n- 引用文献的关键技术内容（至少2-3条要点）\n- 每条标注【来源: block_id】\n\n### 步骤2：按报告结构输出详尽分析\n\n## 报告结构\n\n### 一、引用文献逐篇梳理\n| 序号 | 文献编号（完整格式） | 类型 | 引用方 | 关键技术内容 | 来源 |\n\n### 二、审查员引用文献分析\n1. 审查员引用了哪些文献？列出每篇引用文献的编号、类型和相关性说明\n2. 审查员引用该文献针对哪个权利要求、用于什么驳回理由\n\n### 三、申请人引用文献分析\n1. 申请人引用了哪些文献？与审查员引用有何异同\n2. 申请人引用该文献的目的\n\n### 四、引用文献技术领域分布\n- 引用文献的技术领域分布\n- 是否涉及竞争对手专利\n- 是否存在同族关系\n\n### 五、引用文献对本专利权利要求的影响评估\n- 每篇引用文献对权利要求的具体影响\n- 哪些文献可能构成强无效理由\n\n### 六、建议关注的引用文献和潜在风险\n- 优先关注的引用文献\n- 潜在风险分析\n\n## 关键规则\n- 每一句话和结论都必须标注来源，使用 【来源: block_id】 格式\n- **找不到合适block_id时**：标注 `【来源缺失: 原因说明】`，不得编造block_id\n- **保留完整专利号格式**：引用文献的专利号必须保留原文格式，包括：\n  * 紧凑格式（US12345678B2）\n  * 带括号的自然语言格式（[U.S. Patent No. 3,474,369]）\n  * 外国专利格式（DE 1971624 U、JP 59-104108）\n  * **中文格式**（美国专利第11,897,095号、专利申请号: 18/439,466）\n  不要省略国家代码或后缀，不要改写为"美国专利12345678"等简化格式。完整专利号会被自动识别为可点击链接\n- **禁止使用"略"、"等"省略性表述**\n- 请用中文回答',
