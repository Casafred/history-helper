...
var AI = (function () {
  ...
  var DEFAULT_PROMPTS = {
    ...
    citedRefsAnalysis: '请对以上引用文献相关文档进行分析，包括：\n1. 审查员引用了哪些文献？列出每篇引用文献的编号、类型和相关性说明\n2. 申请人引用了哪些文献？与审查员引用有何异同\n3. 引用文献的技术领域分布，是否涉及竞争对手专利\n4. 引用文献对本专利权利要求的影响评估\n5. 建议关注的引用文献和潜在风险\n\n**注意**：\n- 每一句话和结论都必须标注来源，使用 【来源: block_id】 格式\n- **保留完整专利号格式**：引用文献的专利号必须保留原文格式，包括紧凑格式（US12345678B2）、带括号的自然语言格式（[U.S. Patent No. 3,474,369]）、外国专利格式（DE 1971624 U、JP 59-104108）。不要省略国家代码或后缀，不要改写为"美国专利12345678"等格式。完整专利号会被自动识别为可点击链接\n- 请用中文回答',
